...
return array(
    ...
    "Invalid type given, value should be a string" => "O tipo especificado é inválido, o valor deve ser uma string",
    "'%value%' is not a valid email address in the basic format local-part@hostname" => "'%value%' não é um endereço de e-mail válido no formato seumail@dominio.com",
    ...
    "The two given tokens do not match" => "As senhas fornecidas não combinam",
